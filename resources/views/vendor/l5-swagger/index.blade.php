        ...
        window.onload = function() {
            ...
            const ui = SwaggerUIBundle({
                ...
                requestInterceptor: function(request) {
                    ...
                    request.headers['Accept-Language'] = '{{ config('app.locale') }}';
                    return request;
                },
            ...
            new MutationObserver(function() {
                document.querySelectorAll('.response-col_description h5').forEach(function(h5) {
                    if (h5.textContent.trim() === 'Response headers') {
