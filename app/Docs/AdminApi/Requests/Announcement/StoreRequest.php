...
#[OA\Schema(
    schema: 'AdminApi.Announcement.StoreRequest',
...
class StoreRequest
{
    ...
    #[OA\Property(description: '目標對象', enum: [TargetAudience::class], example: TargetAudience::ALL_USERS->value)]
    public string $targetAudience;

    #[OA\Property(description: '發布時間（須晚於或等於現在）', example: '2026-07-01 00:00:00')]
    public string $publishAt;

    #[OA\Property(description: '到期時間（須晚於發布時間；null 代表永久發布）', example: '2026-07-31 23:59:59')]
